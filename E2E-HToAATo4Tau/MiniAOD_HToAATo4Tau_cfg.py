...
# with command line options: --python_filename MiniAOD_HToAATo4Tau_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:MiniAOD_HToAATo4Tau.root --conditions 130X_mcRun3_2023_realistic_postBPix_v6 --step PAT --geometry DB:Extended --filein file:AOD_HToAATo4Tau.root --era Run3_2023 --no_exec --mc -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:AOD_HToAATo4Tau.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:MiniAOD_HToAATo4Tau.root'),
