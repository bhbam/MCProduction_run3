...
# with command line options: --python_filename AOD_HToAATo4Tau_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:AOD_HToAATo4Tau.root --conditions 130X_mcRun3_2023_realistic_postBPix_v6 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:HLT_Pielup_HToAATo4Tau.root --era Run3_2023 --no_exec --mc -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HLT_Pielup_HToAATo4Tau.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:AOD_HToAATo4Tau_extra_collection.root'),
