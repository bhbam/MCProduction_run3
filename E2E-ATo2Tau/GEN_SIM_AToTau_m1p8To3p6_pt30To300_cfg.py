...
process.genAToTauFilter = cms.EDFilter("GenAToTauFilter_unphysical",
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:aToTau_m1p8To3p6_pt30To300_GEN.root'),
...
process.generator = cms.EDFilter("Pythia8PtGunV3p1",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '25:new = PA PAbar 2 -3 0 2.6 1 1.77779 3.59999 0.',# name antiName spinType chargeType colType m0 mWidth mMin mMax tau0
...
process.generation_step = cms.Path(process.pgen+process.genAToTauFilter)
