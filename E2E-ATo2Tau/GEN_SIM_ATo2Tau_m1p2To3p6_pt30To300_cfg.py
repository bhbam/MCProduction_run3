...
process.genAToTauTauFilter_unphysical = cms.EDFilter("GenAToTauTauFilter_unphysical",
    ...
    taudRCut  = cms.double(0.01)             #Unphysical sample are below 3.6 which gives merged so I want to these hight merged
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:aToTauTau_m1p2To3p6_pt30To300_GEN_SIM.root'),
...
process.generation_step = cms.Path(process.pgen+process.genAToTauTauFilter_unphysical)
