...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HLT_Pielup_QCD_pt15to7000_Run3Summer23GS.root'),
...
# Other statements
process.mixData.input.fileNames = cms.untracked.vstring(open('./neutrino_gun_pielup_files.txt').readlines())
