...
process.RandomNumberGeneratorService = cms.Service("RandomNumberGeneratorService",
    ...
    externalLHEProducer = cms.PSet(
        engineName = cms.untracked.string('MixMaxRng'),
        initialSeed = cms.untracked.uint32(530151)
    ),
    ...
    generator = cms.PSet(
        engineName = cms.untracked.string('MixMaxRng'),
        initialSeed = cms.untracked.uint32(961962)
    ),
    hbhereco = cms.PSet(
        engineName = cms.untracked.string('MixMaxRng'),
...
process.schedule = cms.Schedule(*[ process.lhe_step, process.generation_step, process.genfiltersummary_step, process.simulation_step, process.endjob_step, process.RAWSIMoutput_step ], tasks=[process.patAlgosToolsTask])
