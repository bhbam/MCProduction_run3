...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HLT_Primix_HTo2Tau_TSG-Run3Summer23BPixwmLHEGS-00003.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:AODSIM_HTo2Tau_hadronic.root'),
