...
inputProcess_ ="/HTo2Tau_hadronic_GEN_SIM/lpcml-crab_HTo2Tau_hadronic_GEN_SIM-0f2e5b6bf7a0f1646ac597e543b20e41/USER"

#config.section_('General')
config.General.requestName = 'HTo2Tau_hadronic_HLT_Primix'
...
config.JobType.psetName = 'step2_HLT_Primix_HTo2Tau_hadronic_TSG-Run3Summer23BPixDRPremix-00100_1_cfg.py'
