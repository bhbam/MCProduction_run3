...
# with command line options: Configuration/GenProduction/python/TSG-Run3Summer23BPixwmLHEGS-00003-fragment.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --conditions 130X_mcRun3_2023_realistic_postBPix_v2 --beamspot Realistic25ns13p6TeVEarly2023Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int() --step LHE,GEN,SIM --geometry DB:Extended --era Run3_2023 --python_filename GEN_SIM_HTo2Tau_TSG-Run3Summer23BPixwmLHEGS-00003_1_cfg.py --fileout file:GEN_SIM_HTo2Tau_TSG-Run3Summer23BPixwmLHEGS-00003.root --number 100 --number_out 100 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TSG-Run3Summer23BPixwmLHEGS-00003-fragment.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GEN_SIM_HTo2Tau_TSG-Run3Summer23BPixwmLHEGS-00003.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GEN_SIM_HTo2Tau_TSG-Run3Summer23BPixwmLHEGS-00003_inLHE.root'),
