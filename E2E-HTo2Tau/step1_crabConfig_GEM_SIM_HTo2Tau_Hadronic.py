...
config.General.requestName = 'HTo2Tau_hadronic_GEN_SIM'
...
config.JobType.psetName = 'step1_GEN_SIM_HTo2Tau_TSG-Run3Summer23BPixwmLHEGS-00003_1_cfg.py'
config.Data.outputPrimaryDataset = 'HTo2Tau_hadronic_GEN_SIM'
