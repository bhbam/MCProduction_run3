...
inputProcess_ ="/HTo2Tau_hadronic_GEN_SIM/lpcml-HTo2Tau_hadronic_AOD-95c11d769a94d1b6837b0af1a07c8b5e/USER"

#config.section_('General')
config.General.requestName = 'HTo2Tau_hadronic_MiniAOD'
