...
inputProcess_ ="/HTo2Tau_hadronic_GEN_SIM/lpcml-HTo2Tau_hadronic_MiniAOD-83240413c55a4e856cb7e442223e2991/USER"

#config.section_('General')
config.General.requestName = 'HTo2Tau_hadronic_NanoAOD'
